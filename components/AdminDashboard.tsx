        ...
        <div className="animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {members.map(m => (
                  <div key={m.id} className="bg-zinc-900/30 border border-white/5 p-10 rounded-[3rem] group hover:border-fuchsia-500/30 transition-all">
                    ...
                    <button onClick={() => alert('Accessing Bio-Log History...')} className="w-full bg-white/5 border border-white/5 text-white py-5 rounded-2xl text-[9px] font-black uppercase hover:bg-white/10 tracking-widest transition-all">Synchronize Matrix</button>
                  </div>
                ))}
              </div>
            )
          ...
          {activeTab === 'staff' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {admins.map(admin => (
                  <div key={admin.id} className="bg-zinc-900/30 border border-white/5 p-8 rounded-[3rem] flex items-center gap-6">
